...
bus_cascade = cv2.CascadeClassifier('/home/clone/Desktop/clone/Vehicule_Detector/XMLFiles/bus.xml')
...
while True:
    ...
    trucks = bus_cascade.detectMultiScale(gray, scaleFactor, 5, minSize=(70, 70))
